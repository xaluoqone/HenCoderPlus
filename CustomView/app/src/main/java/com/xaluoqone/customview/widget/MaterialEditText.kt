...
class MaterialEditText(context : Context , attrs : AttributeSet? = null) : AppCompatEditText(context , attrs) {
    ...
    private val topHintAnimatorSet = AnimatorSet().apply {
        playTogether(topHintTextSizeChangeAnimator , topHintYChangeAnimator , topHintTextColorChangeAnimator)
        duration = 100
    }
